...
public class AccountOverviewController {
	...
	private void handleDeleteAction(ActionEvent event) {
		List<Transaction> transactionList = transactionsTable.getSelectionModel()
				.getSelectedItems();
		RemoveTransactionsCommand removeTransactionsCommand = new RemoveTransactionsCommand(transactionList, data);
