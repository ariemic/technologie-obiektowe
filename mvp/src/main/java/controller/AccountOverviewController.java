...
public class AccountOverviewController {
	...
	public void handleAddAction(ActionEvent actionEvent) {
		...
		//todo why this option doesn't work
//		TransactionEditDialogPresenter dialogPresenter = new TransactionEditDialogPresenter();
//		Stage dialogStage = new Stage();
//		dialogPresenter.setDialogStage(dialogStage);
//		dialogPresenter.setData(transaction);
//		dialogStage.showAndWait();
//
//		if (dialogPresenter.isApproved()) {
//			data.addTransaction(transaction);
//		}
